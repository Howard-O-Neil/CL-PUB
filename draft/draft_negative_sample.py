...
def count_train():
    sample_neg_dir = "gs://clpub/data_lake/arnet/tables/coauthor_negative_train/merge-0" \
...
def count_test():
    sample_neg_dir = "gs://clpub/data_lake/arnet/tables/coauthor_negative_test/merge-0" \
