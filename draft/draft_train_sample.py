...
def activity():
    sample_dir = "gs://clpub/data_lake/arnet/tables/activity_sample_train/merge-0" \
...
def content():
    sample_dir = "gs://clpub/data_lake/arnet/tables/content_sample_train/merge-0" \
...
def org_discrete():
    sample_dir = "gs://clpub/data_lake/arnet/tables/org_discrete_sample_train/merge-0" \
...
def org_rank():
    sample_dir = "gs://clpub/data_lake/arnet/tables/org_rank_sample_train/merge-0" \
...
def rwr_bias():
    rwr_bias_dir = "gs://clpub/data_lake/arnet/tables/rwr_bias_sample_train/merge-0" \
