...
dst_dir                 = "gs://clpub/data_lake/arnet/tables/paper_vect/merge-"
...
pooling_data.write.mode("overwrite").parquet(dst_dir + "Hash-8500")

repartition_dir = "gs://clpub/data_lake/arnet/tables/paper_vect/repartition-"
repartition_pooling = spark.read.schema(pooling_schema).parquet(dst_dir + "Hash-8500")
repartition_pooling.repartition(120).write.parquet(repartition_dir + "Hash-8500")
