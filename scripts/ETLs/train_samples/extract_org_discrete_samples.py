...
ranking_samples_writer.repartition(optimized_partition_num).write.mode("overwrite").parquet("hdfs:///temp/recsys/org_discrete_train")
...
ranking_samples = spark.read.schema(org_discrete_sample_schema).parquet("hdfs:///temp/recsys/org_discrete_train")
