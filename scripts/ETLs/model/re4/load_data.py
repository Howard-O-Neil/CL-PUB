...
train_hdfs_dir = "hdfs:///temp/recsys/train/re4"
test_hdfs_dir = "hdfs:///temp/recsys/test/re4"
...
train_writer = spark.sql("""
    select ctv.author1, ctv.author2, ctv.cos_dist, otv.org_rank_proximity, rtv.rwr_bias_proximity, ctv.label
