...
def model_creator(config):
    ...
    linear2 = tf.keras.layers.Dense(units=64, \
        activation='relu', \
        kernel_initializer=initializer, \
        bias_initializer=initializer, \
        kernel_regularizer=regularizer, \
    ...
    SVM_layer = tf.keras.layers.Dense(units=32, \
        kernel_initializer=initializer, \
        bias_initializer=initializer, \
        kernel_regularizer=regularizer, \
        bias_regularizer=regularizer)
...
model.load_weights("/home/hadoop/model/re6/model.h5")
...
df.to_csv("/home/hadoop/model/re6/eval.csv")
