...
model.load_weights("/home/hadoop/model/re4/model.h5")
...
def cal_test_df():
    ...
    return spark.sql("""
        select tv.cos_dist as f1, tv.org_rank_proximity as f2, tv.rwr_bias_proximity as f3, cast(tv.label as int) as label,
...
test_sample_feature = test_sample_np[:, 0:3]
test_sample_label   = test_sample_np[:, 3:4]
test_sample_collab  = test_sample_np[:, 4:5]
...
df.to_csv("/home/hadoop/model/re4/eval.csv")
