...
train_samples_bigdl = spark.sql("""
    select tv.cos_dist as f1, tv.org_discrete_proximity as f2,
...
feature_np = train_samples_np[:, 0:2]
label_np = train_samples_np[:, 2:3]
...
history_file = "/home/hadoop/model/re3/train.csv"
...
model.save_weights("/home/hadoop/model/re3/model.h5")
