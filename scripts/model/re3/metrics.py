...
def model_creator(config):
    x_inputs = tf.keras.Input(shape=(2,))
...
model.load_weights("/home/hadoop/model/re3/model.h5")
...
def cal_test_df():
    ...
    return spark.sql("""
        select tv.cos_dist as f1, tv.org_discrete_proximity as f2, cast(tv.label as int) as label,
...
test_sample_feature = test_sample_np[:, 0:2]
test_sample_label   = test_sample_np[:, 2:3]
test_sample_collab  = test_sample_np[:, 3:4]
...
df.to_csv("/home/hadoop/model/re3/eval.csv")
