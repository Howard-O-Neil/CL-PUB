...
model.load_weights("/home/hadoop/model/re1/model.h5")
...
test_sample_feature = test_sample_np[:, 0:1]
test_sample_label   = test_sample_np[:, 1:2]
test_sample_collab  = test_sample_np[:, 2:3]
