...
def model_creator(config):
    ...
    linear1 = tf.keras.layers.Dense(units=256, \
        activation='relu', \
    ...
    linear2 = tf.keras.layers.Dense(units=256, \
        activation='relu', \
        kernel_initializer=initializer, \
        bias_initializer=initializer, \
        kernel_regularizer=regularizer, \
    ...
    SVM_layer = tf.keras.layers.Dense(units=128, \
        kernel_initializer=initializer, \
        bias_initializer=initializer, \
        kernel_regularizer=regularizer, \
        bias_regularizer=regularizer)
...
history_file = "/home/hadoop/model/re8/train.csv"
...
model.save_weights("/home/hadoop/model/re8/model.h5")
