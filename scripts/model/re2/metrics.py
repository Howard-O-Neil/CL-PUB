...
model.load_weights("/home/hadoop/model/re2/model.h5")
...
def cal_test_df():
    ...
    return spark.sql("""
        select tv.cos_dist as f1, tv.org_rank_proximity as f2, cast(tv.label as int) as label,
...
df.to_csv("/home/hadoop/model/re2/eval.csv")
