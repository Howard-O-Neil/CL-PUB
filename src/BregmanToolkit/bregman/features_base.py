...
class Features(object):
    ...
    def _stft(self):
        ...
        # print(self.x)
        # print(len(self.x))
        num_frames = (int)(self.x.num_frames / self.x.n)
    ...
    def _chroma(self):
        ...
        a,b = self.CQFT.shape
        complete_octaves = (int)(a/self.nbpo) # integer division, number of complete octaves
        ...
        for k in P.arange(complete_octaves):
            new_k = (int)(k)
            self.CHROMA +=  self.CQFT[new_k*self.nbpo:(new_k+1)*self.nbpo,:]
